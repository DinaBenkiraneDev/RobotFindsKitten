...
/**
 * ClasseNonKitten, initie tout les items nonKitten avec une phrase speciale
 *
 * @auteur Alexandre Dufour et Dina Benkirane
 */
public final class NonKitten extends Case {

    private String description;


    /**
     * Constructeur de NonKittenItem ayant une representation et une description aleatoire parmie String[] descriptions.
     */
    public NonKitten() {
        this.representation = super.getRandomSymbole();
        this.description = descriptions[(int) (Math.random() * 405 + 1)];
    }

    /**
     * Constructeur de cases vide dans la grille qui pourra contenir un NonKittenItem, une clef, un teleporteur
     * ou le robot.
     * Utiliser aussi pour remplacer les cases des clef une fois celle-ci prise, pour remplacer une porte
     * une fois celle-ci ouverte, ou un teleporteur une fois celui-ci pris.
     * Pour les cases vides, les nonKitten n'ont pas de description.
     *
     * @param vide Distinction entre le constructeur NonKitten contenant un item et le constructeur d'une case vide.
     */
    public NonKitten(String vide) {
        this.representation = ' ';
        this.description = "";
    }

    /**
     * @param robot Le robot qui interagirait avec la case nonKittenItem
     * @return l'interaction est possible en tout temps
     */
    ...
    /**
     * Va retourner la description du nonKittenItem en haut de la grille
     *
     * @param robot Le robot qui interagirait avec la case nonKittenItem
     */
    ...
    //Prend un phrase au hasard pour chaque nonKittenItem
